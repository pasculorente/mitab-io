...
public class Tab25InteractionParserTest {
	...
	public void getFields() {
		...
		final List<Field> fields = TabInteractionParser.instance(PsiMitabVersion.TAB_25).parseField(a);
	...
	public void getOneField() {
		...
		final List<Field> fields = TabInteractionParser.instance(PsiMitabVersion.TAB_26).parseField(a);
